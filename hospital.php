...
<br><br><br> 
<center>
<a href="https://updgmh-covid19.maps.arcgis.com/apps/opsdashboard/index.html#/bfc888151feb48928a4f6885ca20e83c">
<button   id="mapsbtn" >List Of Dedicated Covid19 Hospitals/Treatment Facilities</button></a></center><br><br>

  <div class="whole-wrap">
                        <div class="container box_1170">

                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Hospitals In Uttar Pradesh</h2>
                                 <?php
                                  $query = "SELECT * FROM hosp_list WHERE state='uttar pradesh'";
 ...
 <center>
<a href="https://updgmh-covid19.maps.arcgis.com/apps/opsdashboard/index.html#/bfc888151feb48928a4f6885ca20e83c">
<button   id="mapsbtn" >District-Wise Covid Care Centre Isolation Beds </button></a></center><br><br>
