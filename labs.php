...
<!-- ======= Features Section ======= -->
        ...
        <ul class="nav nav-tabs row d-flex">
          ...
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="300">
            <a class="nav-link" data-toggle="tab" href="#tab-4">
              ...
              <h4 class="d-none d-lg-block">COVID UTTAR-PRADESH UPDATES</h4>
            </a>
          </li>
        </ul>
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <p class="font-italic">
                  The following data provides data on testing done at centers in Uttar Pradesh for the treatment & diagnosis of COVID-19.
                </p>
                <ul>
             ...
             <iframe src="https://www.google.co.in/maps/d/embed?mid=1fsbbipt815l8A3mTicjEzAFExyLZjXET" width="640" height="480"></iframe>
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> <span><a href="tel:1074">1074</a></span> </li>
 ...
 <button id="mapsbtn">GO TO CHATBOT</button></a>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>Clinics  & Testing centers in UTTAR-PRADESH</h3>
...
<div class="container table-responsive">
  ...
  <h1 style="text-align: center;">DAILY-RECORDS OF TESTING IN UTTAR-PRADESH</h1>
