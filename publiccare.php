      ...
      <div class="container">
        ...
        <ul class="nav nav-tabs row d-flex">
          ...
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="200">
            <a class="nav-link" data-toggle="tab" href="#tab-3">
              ...
              <h4 class="d-none d-lg-block">STATISTICS</h4>
            </a>
          </li>
        ...
        <div class="tab-content" data-aos="fade-up">
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> <n2 >UTTAR-PRADESH CONFIRMED<h2>
                  <n2 id="dc"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>UTTAR-PRADESH RECOVERED<h2>
                  <n2 id="dr"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>UTTAR-PRADESH DEATHS<h2>
                  <n2 id="dd"><h2></li>
                </ul>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>Laboratories For Covid-19 Diagnosis in Uttar-Pradesh</h3>
                
                <p class="font-italic">

                  List of labs/testing centers
                  <br>
                  <a href=" https://updgmh-covid19.maps.arcgis.com/apps/opsdashboard/index.html#/a7e1312f811d4f3f9e984b4a9f09f960" class="btn-buy"><button id="mapsbtn">TESTING CENTERS</button></a>
...
Array.prototype.sum = function (prop) {
    ...
    var DelhiConfirmed = covid_data[34].districtData.sum("confirmed");
    document.getElementById("dc").innerHTML = DelhiConfirmed
    var DelhiDeceased = covid_data[34].districtData.sum("deceased");
    document.getElementById("dd").innerHTML = DelhiDeceased
        var DelhiRecovered = covid_data[34].districtData.sum("deceased");
        ...
        <div class="container-fluid">
          <div class="row" data-aos="fade">
            ...
            <div class="container" style="position: center;">
              <CENTER>
<img class="responsive" src="img/up/p.png">
</CENTER>
</div>
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='uttar pradesh'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN UTTAR-PRADESH</h1>
  <br><br>
  <!-- <CENTER>
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    var newArray = covid_data.records.filter(function (el) {
      ...
      return el.state_name === 'Uttar Pradesh';
